...
def get_useless_skills(weapon):
    ...
    if weapon == "Hunting Horn":
        ...
        return x
    if weapon == "Bow":
        x = ["Artillery", "Power Prolonger", "Capacity Boost", "Guard", "Offensive Guard", "Horn Maestro", "Guard Up", "Handicraft", "Speed Sharpening"]
        return x
    if weapon == "Light Bowgun":
        x = ["Power Prolonger", "Capacity Boost", "Guard", "Offensive Guard", "Horn Maestro", "Bow Charge Plus", "Guard Up", "Handicraft", "Speed Sharpening"]
        return x
    if weapon == "Heavy Bowgun":
        x = ["Power Prolonger", "Capacity Boost", "Horn Maestro", "Bow Charge Plus", "Handicraft", "Speed Sharpening"]
        return x
